...
/**
 * Returns only MIME types accepted by the resize utility.
 * This avoids the TypeScript error caused by returning a generic string.
 */
...
function getResultFormat(blobType: string) {
...
export default function ResizeImageTo1080x1080Client() {
  ...
  const processImage = async () => {
    ...
    try {
      ...
      setResult({
        ...
        format: getResultFormat(output.blob.type),
        fileName: `${originalName}-1080x1080.${extension}`,
      });
          ...
          <div className="mx-auto max-w-7xl px-5 pb-12 pt-14 sm:px-6 lg:px-8 lg:pb-16 lg:pt-20">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600 sm:text-xl">
                ...
                . Create a high-resolution square image online for free.
              </p>
                ...
                <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-slate-950">
                      1080 × 1080 Image Resizer
                    </h2>

                    <p className="mt-1 text-sm text-slate-500">
                      Upload an image and create an exact 1080×1080 pixel copy.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-6 text-center">
                      ...
                      <h3 className="mt-4 text-2xl font-black text-slate-950">
                        Your 1080×1080 image is ready
                      </h3>

                      <p className="mt-2 text-sm text-slate-600">
                        The image has been resized to exactly 1080×1080 pixels.
                      </p>
                    ...
                    <div className="grid gap-6 lg:grid-cols-[1fr_300px]">
                      ...
                      <div className="flex min-h-[340px] items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 p-6">
                        ...
                        <img
                          src={result.url}
                          alt="Resized 1080x1080 image preview"
          ...
          <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 lg:px-8 lg:py-20">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                A popular square image dimension for digital content
              </h2>

              <p className="mt-5 text-lg leading-8 text-slate-600">
                1080×1080 pixels creates a square 1:1 image with enough
                resolution for many social media posts, digital graphics,
                thumbnails, marketing materials, and other online uses.
              </p>
              ...
              {[
                {
                  ...
                  text: "Create square images for social media posts and other platforms that support 1:1 content.",
                  icon: "◈",
                },
                {
                  title: "Marketing images",
                  text: "Prepare high-resolution square graphics for campaigns, promotions, products, and digital marketing.",
                  icon: "✦",
                },
                {
                  title: "Website content",
                  text: "Create consistent square images for cards, galleries, product sections, thumbnails, and other web layouts.",
                  icon: "▦",
                },
              ].map((item) => (
                <div
        ...
        <section className="mx-auto max-w-7xl px-5 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                Resize your image to 1080×1080 in three steps
              </h2>

              <p className="mt-5 text-lg leading-8 text-slate-600">
                Create an exact 1080×1080 square image directly in your
                browser without installing image editing software.
              </p>
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                [
                  "02",
                  "Use the 1080×1080 target",
                  "This page is already configured to create an exact 1080×1080 pixel image.",
                ],
                [
                  "03",
                  "Download your result",
                  "Process the image and download the finished square image to your device.",
                ],
        ...
        <section className="border-y border-slate-100 bg-white">
          <div className="mx-auto max-w-4xl px-5 py-14 sm:px-6 lg:px-8 lg:py-20">
            ...
            <article className="prose prose-slate max-w-none">
              ...
              <h2>
                How to resize an image to 1080x1080 pixels
              </h2>

              <p>
                Resizing an image to 1080x1080 pixels means creating an
                image that is exactly 1080 pixels wide and 1080 pixels high.
                Because both dimensions are equal, the resulting image has
                a square 1:1 aspect ratio.
              </p>

              <p>
                With Lets Resize It, you can upload an image and create a
                1080x1080 version directly in your browser. The tool is
                useful when a website, social media platform, design
                workflow, marketing campaign, or other digital service
                requires a square image at this size.
              </p>

              <h3>
                What does 1080x1080 pixels mean?
              </h3>

              <p>
                The first number represents the image width and the second
                number represents its height. A 1080x1080 image therefore
                contains 1080 pixels across and 1080 pixels vertically.
              </p>

              <p>
                Since the width and height are identical, the image has a
                1:1 aspect ratio. This makes 1080x1080 particularly useful
                for square digital content.
              </p>

              <h3>
                Why is 1080x1080 a useful image size?
              </h3>

              <p>
                1080x1080 provides considerably more pixel detail than
                smaller square dimensions such as 200x200 or 300x300.
                It can therefore be useful when you need a larger square
                image for digital publishing, social media, marketing
                graphics, websites, and other online content.
              </p>

              <p>
                However, the correct image size always depends on the
                platform or application where the image will be used.
                Check the specific requirements of the destination before
                uploading your final image.
              </p>

              <h3>
                Can you resize JPG, PNG and WebP to 1080x1080?
              </h3>

              <p>
                Yes. You can upload supported JPG, PNG, and WebP images and
                create an exact 1080x1080 output. You can also choose a
                different supported output format when needed.
              </p>
              ...
              <div className="not-prose my-8 grid gap-4 sm:grid-cols-3">
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    Resize PNG images while preserving supported PNG output.
                  </p>
                </Link>
              ...
              <p>
                If 1080x1080 is not the required size, Lets Resize It also
                provides other fixed-size image resizing tools.
              </p>
              ...
              <div className="not-prose my-10 rounded-3xl bg-slate-950 p-7 text-white sm:p-9">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">
                  A 1080x1080 image describes its pixel dimensions. It does
                  not guarantee a specific file size in KB or MB. If a
                  website asks for both exact dimensions and a maximum file
                  size, you may need to resize and compress the image
                  separately.
                </p>
        ...
        <section className="bg-slate-50">
          <div className="mx-auto max-w-4xl px-5 py-14 sm:px-6 lg:px-8 lg:py-20">
            ...
            <div className="text-center">
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
                Resize image to 1080x1080 questions
              </h2>
            ...
            <div className="mt-10 space-y-4">
              ...
              {[
                [
                  "How do I resize an image to 1080x1080?",
                  "Upload your image using the tool above. The page is configured for an exact 1080×1080 pixel output, so you can process and download your square image directly.",
                ],
                [
                  "Can I resize JPG to 1080x1080?",
                  "Yes. Upload a JPG and create an exact 1080×1080 version. You can keep JPG or choose another supported output format.",
                ],
                [
                  "Can I resize PNG to 1080x1080?",
                  "Yes. PNG images can be resized to exactly 1080×1080 pixels. You can preserve PNG output or choose another supported format.",
                ],
                [
                  "Can I resize WebP to 1080x1080?",
                  "Yes. WebP images can be resized to exactly 1080×1080 pixels and downloaded as WebP or another supported format.",
                ],
                [
                  "Is 1080x1080 a square image?",
                  "Yes. Because the width and height are both 1080 pixels, the resulting image has a 1:1 square aspect ratio.",
                ],
                [
                  "Is this 1080x1080 image resizer free?",
                  "Yes. Lets Resize It provides this online 1080×1080 image resizing tool for free.",
                ],
              ].map(([question, answer]) => (
                <details
                  key={question}
        ...
        <section className="mx-auto max-w-7xl px-5 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-slate-600">
              Choose another Lets Resize It tool for a different dimension,
              format, or file-size requirement.
            </p>
